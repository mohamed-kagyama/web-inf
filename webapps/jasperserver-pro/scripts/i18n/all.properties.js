...
module.exports = {
  ...
  "timezone.option": "{0} - {1}",
  "error.staging.query.time.out.only.integers.above.zero": "Only integer number above zero is allowed.",
  "error.description.is.too.long": "The description is too long.The maximum length is {0} characters.",
  "error.name.is.too.long": "The name is too long.The maximum length is {0} characters.",
  "error.name.is.required": "Name is required for data staging.",
  "error.staging.query.time.out.units.oneOf": "Time to keep query result in cache should be in minutes, hours or days.",
  "error.min.staging.query.time.out.units": "Minimal allowed value is {0} minutes.",
  "error.max.staging.query.time.out.units": "Maximum allowed value is {0} minutes.",
  "client.delimiters.decimal": ".",
  "client.delimiters.thousands": ",",
  // domain designer bundle mock
  // validation
  "domain.validation.invalidInitialResourceValue": "Invalid Initial Resource value",
  "domain.validation.invalidStateValue": "Invalid state value",
  "domain.designer.error.dialog.validation.message": "Domain schema contains invalid reference:",
  "domain.designer.error.dialog.validation.alert": "There are problems with the domain schema file:",
  // designers
  "domain.designer.metadataDesignerView.schemaAttribute.title": "You may also add a Schema attribute:",
  // joins
  "domain.designer.joinsDesigner.joinConstructor.dragLeftJoinFieldHere": "Drag left join field here",
  "domain.designer.joinsDesigner.joinConstructor.dragRightJoinFieldHere": "Drag right join field here",
  "domain.designer.joinsDesigner.joinConstructor.createJoin": "Create Join",
  "domain.designer.joinsDesigner.joinConstructor.generateJoins": "domain.designer.joinsDesigner.joinConstructor.generateJoins",
  "domel.expression.invalid.character": "{invalidCharacter} {charPositionInLine}",
  // context menus
  "domain.validation.tableName.inUse": "Table is in use",
  "domain.validation.tableName.required": "Table name is required",
  "domain.validation.table.isUsedInComplexJoin": "Table is used in complex join",
  //canvas view
  "domain.designer.canvasViews.label.testDesigner": "testDesignerLabel",
  "domain.designer.draggable.items.selected": "{0} items selected",
  "domain.designer.error.handling.401.not.authenticated": "domain.designer.error.handling.401.not.authenticated",
  "domain.designer.error.handling.403.access.denied": "domain.designer.error.handling.403.access.denied",
  "domain.designer.error.handling.404.not.found": "domain.designer.error.handling.404.not.found",
  "domain.designer.error.handling.params.test": "params {0} test {1}",
  "profile.attribute.exception.value.is.encrypted": "attr {0}",
  "domain.designer.error.dialog.schema.expression.invalid.fields.error.template": "expression {0} with fields [{1}] and source: {2}",
  "domain.designer.error.dialog.schema.join.expression.invalid.group.reference.error.template": "expression {0} with groups [{1}]",
  "domain.designer.error.dialog.schema.xml.parse.error.unexpected.string": "position {0}:{1}",
  "domain.designer.error.dialog.schema.xml.parse.error.unexpected.string.no.column": "position {0}",
  "profile.attribute.exception.substitution.not.found": "name: {0}, category: {1}",
  "profile.attribute.exception.substitution.category.invalid": "invalidCategory: {0}, attribute: {1}, expected: {2}",
  "domain.designer.error.dialog.schema.invalid.join.type.error.template": "invalidJoinType: {0}",
  "domain.designer.error.dialog.domain.security.schema.resource.access.grant.expression.invalid.fields.error.template": "expression {0} with fields [{1}]",
  "domain.designer.error.dialog.domain.security.schema.resource.access.grant.expression.parse.error.template": "expression: {0}, resourcePath: {1}",
  "domain.designer.error.dialog.domain.security.missing.element.error.template": "elements: {0}",
  "domain.designer.error.dialog.schema.constant.group.element.expression.required.error.template": "Constant field {0} of constant group {1}",
  "domain.designer.error.dialog.schema.resources.join.side.invalid.error.template": "Resource: {0}, joinTree: {1}",
  "domain.designer.error.dialog.schema.presentation.element.name.length.limit.category": "limit {0}",
  "domain.designer.error.dialog.schema.presentation.element.label.length.limit.category": "limit {0}",
  "domain.designer.error.dialog.schema.presentation.element.labelId.length.limit.category": "limit {0}",
  "domain.designer.error.dialog.schema.presentation.element.description.length.limit.category": "limit {0}",
  "domain.designer.error.dialog.schema.presentation.element.descriptionId.length.limit.category": "limit {0}",
  "domain.designer.error.dialog.schema.resources.join.reference.name.inconsistent.error.template": "{0} references {1}",
  "domain.designer.error.dialog.schema.element.name.unsupported.character.category": "unsupportedCharacters: {0}",
  "domain.designer.error.dialog.domain.bundle.file.invalid.error.template": "locale: {0}",
  "domain.designer.error.dialog.schema.message": "problems with {0} in {1}",
  "referenced.resource.not.found": "resource {0} attribute {1}",
  "domain.designer.sidebar.empty.profile.attribute.value.placeholder": "empty attribute value",
  "domain.designer.joinsDesigner.create.join.attentionDialog.validationMessageDetails": "fieldName: {0}, tableReferenceName: {1}, dataIslandName: {2}",
  "adh.calculated.fields.validation.successful": "Validation successful!"
};
