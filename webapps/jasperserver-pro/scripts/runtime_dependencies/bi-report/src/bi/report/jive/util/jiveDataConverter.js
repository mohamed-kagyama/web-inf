...
var jiveDataConverter = {
  ...
  jQueryUiTimestampToIsoTimestamp: function jQueryUiTimestampToIsoTimestamp(val, genericProperties) {
  ...
  jQueryUiTimeToIsoTime: function jQueryUiTimeToIsoTime(val, genericProperties) {
    if (val && genericProperties && genericProperties.calendarPatterns) {
  ...
  isoTimestampTojQueryUiTimestamp: function isoTimestampTojQueryUiTimestamp(val, genericProperties) {
    if (val && genericProperties && genericProperties.calendarPatterns) {
  ...
  isoTimeTojQueryUiTime: function isoTimeTojQueryUiTime(val, genericProperties) {
    if (val && genericProperties && genericProperties.calendarPatterns) {
  ...
  filterStartValue: function filterStartValue(operator, value, dataType, genericProperties) {
  ...
  filterEndValue: function filterEndValue(operator, value, dataType, genericProperties) {
    var clearFilter = value == null && operator == null,
        isDatetimeColumn = dataType === "datetime",
        isTimeColumn = dataType === "time";
  ...
  schemaFormatOperatorToFilterOperator: function schemaFormatOperatorToFilterOperator(operator, value, dataType) {
    if (dataType !== "boolean") {
  ...
  operatorAndValueToSchemaFormat: function operatorAndValueToSchemaFormat(operator, dataType, valueStart, valueEnd, pattern) {
    var response = {};
    ...
    if (dataType === "boolean") {
      ...
      if (dataType === "string") {
        ...
        if (dataType === "datetime") {
          if (isRange) {
            response.value = [jiveDataConverter.jQueryUiTimestampToIsoTimestamp(valueStart, genericProperties), jiveDataConverter.jQueryUiTimestampToIsoTimestamp(valueEnd, genericProperties)];
          } else {
            response.value = isNullCheck ? valueStart : jiveDataConverter.jQueryUiTimestampToIsoTimestamp(valueStart, genericProperties);
          }
        } else if (dataType === "time") {
          if (isRange) {
            response.value = [jiveDataConverter.jQueryUiTimeToIsoTime(valueStart, genericProperties), jiveDataConverter.jQueryUiTimeToIsoTime(valueEnd, genericProperties)];
          } else {
            response.value = isNullCheck ? valueStart : jiveDataConverter.jQueryUiTimeToIsoTime(valueStart, genericProperties);
          }
        }
      }
    }
...
module.exports = jiveDataConverter;
