...
var NumberFormatUtil = {
  addRemoveDecimalPlace: function addRemoveDecimalPlace(exp, booleanAdd) {
  ...
  addRemoveThousandsSeparator: function addRemoveThousandsSeparator(exp, booleanAdd) {
  ...
  addRemovePercentage: function addRemovePercentage(exp, booleanAdd) {
  ...
  jivePatternToSchemaPattern: function jivePatternToSchemaPattern(jivePattern, jiveDataType) {
    var result;
...
module.exports = NumberFormatUtil;
