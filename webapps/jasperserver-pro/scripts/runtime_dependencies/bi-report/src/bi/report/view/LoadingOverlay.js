 ...
 */
var localLogger = logger.register("LoadingOverlay");
module.exports = Backbone.View.extend({
  ...
  setExternalContainer: function setExternalContainer(externalContainer) {
    this.$externalContainer = $(externalContainer);
  },
  setBiComponentContainer: function setBiComponentContainer(biComponentContainer) {
    this.$biComponentContainer = $(biComponentContainer);
  },
  setBiComponent: function setBiComponent(biComponent) {
    this.$biComponent = $(biComponent);
  },
  setScaleFactor: function setScaleFactor(scaleFactor) {
  ...
  applyScale: function applyScale(scaleFactor) {
    if (_.isUndefined(scaleFactor)) {
      return;
    }
  ...
  showScrollBarOnContainer: function showScrollBarOnContainer() {
  ...
  hideScrollBarOnContainer: function hideScrollBarOnContainer() {
  ...
  _attachToContainer: function _attachToContainer() {
  ...
  _adjustOverlaySizeAndPosition: function _adjustOverlaySizeAndPosition() {
    var top = 0,
        left = 0,
  ...
  _applyScaleTransform: function _applyScaleTransform() {
