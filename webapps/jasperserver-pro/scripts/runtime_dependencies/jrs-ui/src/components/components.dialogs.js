...
dialogs.popup = {
  ...
  hide: function hide(elem) {
    ...
    if ($elem.hasClassName(layoutModule.CANCELLABLE_CLASS) && $elem.hasClassName(layoutModule.ADHOC_COMPONENT)) {
      $elem.removeClassName(layoutModule.CANCELLABLE_CLASS);
      $elem.removeClassName(layoutModule.ADHOC_COMPONENT);
    }
