  ...
  'folder_mutton': [{
    ...
    'children': [{
      ...
      'children': [{
        ...
        'text': 'Font',
        'action': 'invokeCreate',
        'actionArgs': ['FileResource', 'font']
      }, {
        'type': 'optionAction',
        'className': 'up',
        'text': 'Image',
        'action': 'invokeCreate',
        'actionArgs': ['FileResource', 'img']
      }, {
        'type': 'optionAction',
        'className': 'up',
        'text': 'CSS',
        'action': 'invokeCreate',
        'actionArgs': ['FileResource', 'css']
      }, {
        'type': 'optionAction',
        'className': 'up',
        'text': 'JAR',
        'action': 'invokeCreate',
        'actionArgs': ['FileResource', 'jar']
      }, {
        'type': 'optionAction',
        'className': 'up',
        'text': 'JRXML',
        'action': 'invokeCreate',
        'actionArgs': ['FileResource', 'jrxml']
      }, {
        'type': 'optionAction',
        'className': 'up',
        'text': 'OLAP Schema',
