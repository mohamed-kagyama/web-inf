...
var jdbcfileLocationTemplate = require("text!../template/jdbcfileLocationTemplate.htm");
...
module.exports = BaseDataSourceView.extend({
  ...
  renderDriverCustomAttributeFields: function renderDriverCustomAttributeFields() {
    ...
    var currentDriverName = this.isEditMode && !this.model.changed.selectedDriverClass ? this.options.dataSource.driverClass : this.model.changed.selectedDriverClass;
  ...
  renderFileLocationSection: function renderFileLocationSection() {
    $(_.template(jdbcfileLocationTemplate, {
      'i18n': i18n
    })).insertAfter("[name='oAuthPvtKeyPath']");
