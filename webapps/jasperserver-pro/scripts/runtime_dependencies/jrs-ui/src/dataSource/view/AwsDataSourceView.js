...
var AwsDataSourceModel = require('../model/AwsDataSourceModel');
...
var awsSpecificTemplate = require("text!../template/awsSpecificTemplate.htm");
...
module.exports = JdbcDataSourceView.extend({
  ...
  recheckDriver: function recheckDriver() {
    this.model.validate({
  ...
  initDriverUploadDialog: function initDriverUploadDialog() {
    var self = this,
        driver = this.model.drivers.getDriverByClass(this.model.get('driverClass'));
  ...
  updateInput: function updateInput() {
    ...
    _.each(_.intersection(changedAttributes, inputsToUpdate), function (attr) {
      var newValue = self.model.get(attr),
  ...
  onCredentialsTypeChange: function onCredentialsTypeChange() {
  ...
  refreshAwsDataSourceTree: function refreshAwsDataSourceTree(e) {
    e.preventDefault();
    this.showAwsDsTree('/');
  },
  ...
  showAwsDsTree: function showAwsDsTree(path) {
    this.model.validate({
  ...
  renderAwsSpecificSection: function renderAwsSpecificSection() {
