...
var BaseSaveDialogView = require('../saveDialog/BaseSaveDialogView');

var TextDataSourceSaveDialogView = require('../saveDialog/TextDataSourceSaveDialogView');
...
module.exports = {
  getView: function getView(dataSourceType) {
