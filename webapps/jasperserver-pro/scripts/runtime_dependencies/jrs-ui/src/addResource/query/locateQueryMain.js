...
var resourceQueryLocate = require('../../resource/resource.query.locate');
...
domReady(function () {
  ...
  jQuery('#steps1_2').on('click', function () {
    return resourceQueryLocate.jumpTo('reportNaming');
  });
  jQuery('#step3').on('click', function () {
    return resourceQueryLocate.jumpTo('resources');
  });
  jQuery('#step4').on('click', function () {
    return resourceQueryLocate.jumpTo('dataSource');
  });
  jQuery('#step5').on('click', function () {
    return resourceQueryLocate.jumpTo('query');
  });
  jQuery('#step6').on('click', function () {
    return resourceQueryLocate.jumpTo('customization');
  });
});
