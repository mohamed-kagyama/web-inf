...
var resourceReport = require('../../resource/resource.report');
...
domReady(function () {
  ...
  addAddResourceSection(resourcesContainer, {
    canChangeResources: jrsConfigs.addJasperReport.canChangeResources
  });
  ...
  addAddControlSection(controlsContainer, {
    canChangeResources: jrsConfigs.addJasperReport.canChangeResources
  });
});
