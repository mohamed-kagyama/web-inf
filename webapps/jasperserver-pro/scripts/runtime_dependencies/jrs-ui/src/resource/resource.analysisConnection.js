...
var resourceAnalysisConnection = {
  ...
  _initResourcePicker: function _initResourcePicker() {
  ...
  _initEvents: function _initEvents() {
    ...
    this._form.observe('keyup', function (e) {
      ...
      var targetElements = [this._label, this._resourceId, this._description, this._xmlaCatalog, this._xmlaDataSource, this._xmlaConnectionUri];
  ...
  testXMLAConnection: function testXMLAConnection() {
  ...
  _xmlaCatalogValidator: function _xmlaCatalogValidator(value) {
    var isValid = true;
    var errorMessage = '';
  ...
  _xmlaDataSourceValidator: function _xmlaDataSourceValidator(value) {
    var isValid = true;
    var errorMessage = '';
  ...
  _xmlaConnectionUriValidator: function _xmlaConnectionUriValidator(value) {
    var isValid = true;
    var errorMessage = '';
...
if (typeof require === 'undefined') {
  document.observe('dom:loaded', function () {
    resourceAnalysisConnection.initialize(window.localContext.initOptions);
  });
}

module.exports = resourceAnalysisConnection;
