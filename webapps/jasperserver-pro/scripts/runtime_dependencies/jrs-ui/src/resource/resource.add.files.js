...
var addFileResource = {
  ...
  _initEvents: function _initEvents() {
    ...
    this._form.observe('keydown', function (e) {
      var targetElement = matchAny(e.element(), ['#' + this.DESCRIPTION_ID], true);
  ...
  _pathValidator: function _pathValidator(value) {
    var isValid = true;
    var errorMessage = '';
  ...
  _getTypesForExtension: function _getTypesForExtension(extension) {
    var types = [];
  ...
  _getExtension: function _getExtension() {
  ...
  _getFileNameFromPath: function _getFileNameFromPath(path) {
...
if (typeof require === 'undefined') {
  document.observe('dom:loaded', function () {
    addFileResource.initialize(window.localContext.initOptions);
  });
}

module.exports = addFileResource;
