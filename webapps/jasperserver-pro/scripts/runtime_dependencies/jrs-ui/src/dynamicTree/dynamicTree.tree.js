...
var dynamicTree = {
   ...
   */
  getActiveTree: function getActiveTree() {
   ...
   * @param name the name.
   */
  getStorageVal: function getStorageVal(name) {
   ...
   */
  setStorageVal: function setStorageVal(name, value) {
