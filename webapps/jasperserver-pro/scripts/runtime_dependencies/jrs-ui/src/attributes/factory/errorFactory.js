...
errorCodeToMessageMap['access.denied'] = [i18n['attributes.error.message.access.denied'], ['name']];
...
errorCodeToMessageMap['attribute.invalid.permission.order'] = [i18n['attributes.error.message.invalid.permission.order'], ['name', {
...
errorCodeToMessageMap['attribute.duplicate.server.level'] = [i18n['attributes.error.message.duplicate.server.level'], ['name']];
...
module.exports = function (response) {
  var responseJSON = response.responseJSON || {},
      ...
      msgObj = errorCodeToMessageMap[errorCode ? errorCode : responseStatus] || unknownError,
      msg;
