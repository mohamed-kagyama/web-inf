...
var AttributesDesigner = require('../../attributes/view/AttributesDesigner');

var attributesTypesEnum = require('../../attributes/enum/attributesTypesEnum');

var designerButtonsTrait = require('../../serverSettingsCommon/view/traits/buttonsTrait');

var designerFilterTrait = require('../../attributes/view/trait/designerFilterTrait');

var designerInheritedTrait = require('../../attributes/view/trait/designerInheritedTrait');

var designerPermissionTrait = require('../../attributes/view/trait/designerPermissionTrait');
