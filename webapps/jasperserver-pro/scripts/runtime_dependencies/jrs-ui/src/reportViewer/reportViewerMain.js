...
require('../commons/commons.bare.main');

require('../components/components.dialogs');
...
domReady(function () {
  ...
  require(['ReportRequireJsConfig'], function () {
    ...
    require(['./viewer'], function (Viewer) {
      ...
      Report.initialize(); //workraround to make JIVE jquery-ui datepickers work in ReportViewer
