...
var doNothing = _utilsCommon.doNothing;
var isSupportsTouch = _utilsCommon.isSupportsTouch;
var isIPad = _utilsCommon.isIPad;
 ...
 */
var InfiniteScroll = function InfiniteScroll(options) {
  this._id = options.id;
...
InfiniteScroll.addMethod('wait', function () {
  if (!this._waitIndicator) {
    this._waitIndicator = new Element('div', {
      'class': 'dimmer resultsOverlay'
    });
    ...
    this._control.insert({
      after: this._waitIndicator
    });
  }
