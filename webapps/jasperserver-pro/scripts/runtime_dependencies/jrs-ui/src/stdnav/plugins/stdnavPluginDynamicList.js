...
var stdnavPluginDynamicList = function stdnavPluginDynamicList() {
  gserial++;
  this.serial = gserial;
...
$.extend(stdnavPluginDynamicList.prototype, {
  ...
  // lost.
  _onSuperfocusOut: function _onSuperfocusOut(element) {} // FIXME: ghostfocus
...
module.exports = newStdnavPluginDynamicList;
