...
var Keys = _utilUtilsCommon.Keys;
 ...
 */
var keyManager = {
  ignoreKeyDown: [Keys.DOM_VK_SHIFT, Keys.DOM_VK_CONTROL, Keys.DOM_VK_ALT],
  noBubbleOnKeyUp: [Keys.DOM_VK_F10]
};
...
document.observe('key:enter', function (event) {
  var elem = event.element(),
      matched; //if menu showing - simulate mouseup
