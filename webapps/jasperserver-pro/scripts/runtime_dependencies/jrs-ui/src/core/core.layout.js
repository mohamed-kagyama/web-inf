...
var parseFunc = _utilUtilsCommon.parseFunc;
...
var getDimensionInPx = _utilUtilsCommon.getDimensionInPx;
var getActualDimension = _utilUtilsCommon.getActualDimension;
var isIE8 = _utilUtilsCommon.isIE8;
var isIE9 = _utilUtilsCommon.isIE9;

var Truncator = require('../util/tools.truncator');

var _iscroll = require('iscroll');

var iScroll = _iscroll.iScroll;
...
var layoutModule = {
  ...
  initialize: function initialize(container) {
    container = $(container) || $(document.body); //truncate matching patterns
    //truncate matching patterns

    new Truncator(container.select(layoutModule.TRUNCATE_PATTERN)); //IE7 needs explicit style set (no sensible alternative to browser sniffing here)
    ...
    if (jQuery.datepicker && jQuery.datepicker.initialized) jQuery.datepicker.initialized = false; //make sure ajaxbuffer is available (for dynamicTree)
  ...
  updateOnOrientation: function updateOnOrientation() {},
  //////////////////////////////////////////////////////////////////////
  // visibility
  //////////////////////////////////////////////////////////////////////
  ...
  // panel scrolling
  //////////////////////////////////////////////////////////////////////
  createScroller: function createScroller(scrollContainer, options) {
    if (scrollContainer) {
  ...
  // panel resizing
  //////////////////////////////////////////////////////////////////////
  createSizer: function createSizer(sizeable, options) {
  ...
  getSizerType: function getSizerType(sizer) {
  ...
  alignmentModule: {
     ...
     */
    getSizerAlignment: function getSizerAlignment(sizer, sizerType) {
      var result = ['', ''];
      ...
      var alignmentOffsets = [0, 1].map(function (al) {
  ...
  beginSizerDragging: function beginSizerDragging(dragger, event) {
  ...
  endSizerDragging: function endSizerDragging(dragger, event) {
  ...
  respondToDrag: function respondToDrag(dragger, event) {
  ...
  resizeOnDrag: function resizeOnDrag(dragger, event, orientation) {
  ...
  resizePanelsOnDrag: function resizePanelsOnDrag(dragger, dragData) {
  ...
  isInBounds: function isInBounds(dragger, dragData) {
    //just init variables
    var primaryMinMeasurement,
        sizeableAnchorageMeasurement,
        avaliableParentMeasurement,
        pimaryPanelMarginMeasurement,
        outerDimentionFunc,
  ...
  getSizeTracker: function getSizeTracker() {
    var lastSize = -1;
    return {
      checkpoint: function checkpoint(size) {
        lastSize = size;
      },
      changed: function changed(size) {
  ...
  // Make moveable
  ///////////////////////////////////////////////////////////////////////////////////
  createMover: function createMover(movable) {
  ...
  // Minimizer / Maximizer
  ///////////////////////////////////////////////////////////////////////////////////
  maximize: function maximize(elem, noEffects) {
    noEffects = true;
  ...
  minimize: function minimize(elem, noEffects) {
  ...
  resizeOnClient: function resizeOnClient(leftPanelID, mainPanelID, rightPanelID) {
    var panels = [];
  ...
  autoMaximize: function autoMaximize(element) {
  ...
  autoMinimize: function autoMinimize(element) {
    var minimized = window.localStorage ? localStorage.getItem(element.identify() + layoutModule.MINIMIZED) : 'false';
  ...
  fixIE7Sizes: function fixIE7Sizes() {
