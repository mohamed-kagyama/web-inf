...
var ControlsBase = {
  ...
  setControlError: function setControlError(errorDiv, error) {
    if (!errorDiv) return;
    errorDiv = $(errorDiv);
  ...
  setControlsErrors: function setControlsErrors(errors) {
  ...
  */
   ...
   */
  buildSelectedDataUri: function buildSelectedDataUri(selectedData, extraParams) {
...
var ControlDialog = function ControlDialog(buttonActions) {
  var it = this;
...
var OptionsDialog = function OptionsDialog(buttonActions) {
...
exports.OptionsDialog = OptionsDialog;
exports.ControlDialog = ControlDialog;
