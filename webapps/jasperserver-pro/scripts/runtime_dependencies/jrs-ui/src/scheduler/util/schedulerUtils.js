...
module.exports = {
  ...
  getParamsFromUri: function getParamsFromUri() {
  ...
  saveCurrentLocation: function saveCurrentLocation() {
  ...
  getBackToPreviousLocation: function getBackToPreviousLocation() {
