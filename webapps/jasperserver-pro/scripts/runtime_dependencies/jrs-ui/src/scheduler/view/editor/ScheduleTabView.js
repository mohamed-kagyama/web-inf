...
module.exports = Backbone.View.extend({
  ...
  setupDatepickersOn: function setupDatepickersOn() {
    ...
    this.$el.find(".datepicker").each(function (index, calendar) {
      ...
      _this.listenTo(_this.model, "change:trigger", function () {
        var appTimeZone = moment.tz(_this.model.get("trigger").timezone).utcOffset();
  ...
  calendarChanged: function calendarChanged() {
