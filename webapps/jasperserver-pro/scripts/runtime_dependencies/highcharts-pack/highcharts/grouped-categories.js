...
// #1 amd-fication
//
// #2 14/10/15 Removing rotation of x axis labels unless it's first-level label (JRS-6797)
//
// #3 07/02/18 [object Object] label in Ad Hoc Charts if field contains NULL (JS-33467)
///////////////////////////////////////////////////////////////////////
...
//END JASPERSOFT #1
	...
	function Category(obj, parent) {
        ...
        //JASPERSOFT #3
        this.name = (obj.name !== UNDEFINED && obj.name !== null) ? obj.name : obj;
        //END JASPERSOFT #3
        this.parent = parent;
