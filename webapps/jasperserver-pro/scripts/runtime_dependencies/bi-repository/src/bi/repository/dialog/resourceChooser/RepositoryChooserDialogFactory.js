...
var RepositoryItemChooserDialog = require('./view/RepositoryItemChooserDialogView');

var RepositoryFolderChooserDialog = require('./view/RepositoryFolderChooserDialogView');
...
module.exports = {
  getDialog: function getDialog(dialogType) {
