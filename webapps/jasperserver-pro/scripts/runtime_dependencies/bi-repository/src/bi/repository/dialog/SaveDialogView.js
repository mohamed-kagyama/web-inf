...
var RepositoryResourceBundle = require("bundle!RepositoryResourceBundle");
...
var repositoryTreeFactory = require('../factory/repositoryTreeFactory');

var repositoryResourceTypes = require('../enum/repositoryResourceTypes');

var dialogTemplate = require("text!./resourceChooser/template/saveDialogTemplate.htm");
...
module.exports = DialogWithModelInputValidation.extend({
  ...
  _closeDialog: function _closeDialog() {
    ...
    if (this.foldersTree) {
      this.foldersTree.collapse('/root', {
        silent: true
      });
  ...
  _preselectFolder: function _preselectFolder() {
  ...
  _showNotification: function _showNotification(options) {
    var messageType = options.type || 'success',
  ...
  _showCommonErrorMessageOnDialog: function _showCommonErrorMessageOnDialog(message) {
    var errorHolder = this.$('[name=commonErrorMessage]');
    errorHolder.addClass('error');
    errorHolder.find('span').text(message);
  },
  _clearCommonErrorMessageOnDialog: function _clearCommonErrorMessageOnDialog() {
    var errorHolder = this.$('[name=commonErrorMessage]');
    errorHolder.removeClass('error');
    errorHolder.find('span').text('');
  },
  _findNameOfTheLabel: function _findNameOfTheLabel(resourcesOnServer) {
    var labelWeAreLookingFor = this.model.get('label'),
  ...
  _saveButtonClick: function _saveButtonClick() {
    this._clearCommonErrorMessageOnDialog();
  ...
  _cancelButtonClick: function _cancelButtonClick() {
    this._closeDialog();
  },
  _yesButtonConfirmationDialogClick: function _yesButtonConfirmationDialogClick() {
    this._saveModelOnServer({
      useExistingResource: true
    });
  },
  _noButtonConfirmationDialogClick: function _noButtonConfirmationDialogClick() {
    this.enableButton('save');
    this.enableButton('cancel');
  },
  // ----------------------------------------------------------------------------------
  // Methods to check if the label entered by user is already in use on Server
  _checkIfLabelExistsOnServer: function _checkIfLabelExistsOnServer() {
  ...
  _checkIfLabelExistsOnServerDone: function _checkIfLabelExistsOnServerDone(result) {
  ...
  _checkIfLabelExistsOnServerFail: function _checkIfLabelExistsOnServerFail() {
  ...
  _saveModelOnServer: function _saveModelOnServer(options) {
    ...
    if (options.createNewResource === true) {
      ...
      this._clonedModelForSaving.unset('uri', {
        silent: true
      });
    }
  ...
  _saveModelOnServerDone: function _saveModelOnServerDone(model, data) {
    // copying back from cloned model into actual all values
    // which might be changed by server
    this.model.set(this._clonedModelForSaving.attributes, {
      silent: true
    });
