...
var TooltipPlugin = require("runtime_dependencies/js-sdk/src/common/component/tree/plugin/TooltipPlugin");
...
var resourceDialogTemplate = require("text!../template/itemDialog/resourceDialogTemplate.htm");

var sidebarTreeLeafTemplate = require("text!../template/itemDialog/sidebarTreeLeafTemplate.htm");

var tabPanelButtonTemplate = require("text!../template/itemDialog/tabPanelButtonTemplate.htm");

var treeTooltipTemplate = require("text!../template/itemDialog/treeTooltipTemplate.htm");
...
module.exports = Dialog.extend({
  constructor: function constructor(options) {
    ...
    this.resourcesListView = Tree.use(NoSearchResultsMessagePlugin).use(TooltipPlugin, {
      ...
      processors: [processors.cssClassItemProcessor, processors.filterTempFolderProcessor],
      getDataArray: function getDataArray(data, status, xhr) {
        return data && data[repositoryResourceTypes.RESOURCE_LOOKUP] ? data[repositoryResourceTypes.RESOURCE_LOOKUP] : [];
      },
      getDataSize: function getDataSize(data, status, xhr) {
  ...
  setDefaultSelectedItem: function setDefaultSelectedItem(defaultSelectedItem) {
  ...
  _selectionListener: function _selectionListener(selection) {
  ...
  _resetTreeAndList: function _resetTreeAndList() {
    // reset Tree
    this.resourcesTreeView.collapse('/root', {
      silent: true
    });
    this.resourcesTreeView.collapse('/public', {
      silent: true
    });
  ...
  _preselectItem: function _preselectItem() {
    ...
    this.resourcesListView._onceVisible.done(_.bind(function () {//TODO: Not Yet Ready
  ...
  _tabChangedEvent: function _tabChangedEvent() {
  ...
  _openTab: function _openTab(tabName) {
  ...
  _getErrorDialog: function _getErrorDialog() {
