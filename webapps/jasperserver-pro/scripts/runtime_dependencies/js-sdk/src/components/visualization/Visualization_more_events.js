  ...
  _onTitleChange: function _onTitleChange(newTitle) {
    ...
    if (newTitle) {
      ...
      if ($switcherIcon.hasClass('jr-meatball')) {
        $switcherIcon.removeClass('jr-meatball\'').addClass('jr-chartColumn\'');
      }
    } else {
      ...
      if ($switcherIcon.hasClass('jr-chartColumn')) {
        $switcherIcon.removeClass('jr-chartColumn').addClass('jr-meatball');
      }
    }
  },
  _switcherActivated: function _switcherActivated() {
