 ...
 */
var SearcheableDataProvider = function SearcheableDataProvider(options) {
...
_.extend(SearcheableDataProvider.prototype, {
  ...
  getIndexMapping: function getIndexMapping() {
    return this.indexMapping;
  },
  getReverseIndexMapping: function getReverseIndexMapping() {
    return this.reverseIndexMapping;
  },
  _resolvePromise: function _resolvePromise(options, deferred) {
  ...
  _shouldFilter: function _shouldFilter() {
    return this.criteria;
  },
  _filterValues: function _filterValues(data) {
    var filteredData = [];
    var j = 0;
...
module.exports = SearcheableDataProvider;
