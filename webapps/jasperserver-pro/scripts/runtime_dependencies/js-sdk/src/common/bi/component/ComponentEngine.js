...
var biComponentUtil = require('./util/biComponentUtil');
 ...
 */
var ComponentEngine = function ComponentEngine(schema, properties) {
  this.instanceData = {
...
module.exports = {
  newInstance: function newInstance(schemaString, properties) {
