...
module.exports = {
  ...
  beginModalFocus: function beginModalFocus(element) {
    if (!element) {
      return;
  ...
  // TODO: Find a faster way to do this!
  endModalFocus: function endModalFocus(element) {
    var $el, $nonDialog;
    ...
    $nonDialog.each(function (index, ndEl) {
      ...
      if (typeof priorTabIndex === 'undefined') {// Shouldn't happen, but it might.  Implies content was
