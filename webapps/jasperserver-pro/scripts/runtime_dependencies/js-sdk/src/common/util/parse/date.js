...
var RelativeTimestamp = require('../datetime/RelativeTimestamp');
 ...
 */
var localeSettingsObject = jrsConfigs.localeSettings;
...
function toMomentDatePattern(dateFormat) {
  var result = dateFormat; //convert year part of the format
...
function timestampStringToMoment(value) {
  return moment(value, toMomentTimestampPattern(localeSettingsObject.dateFormat, localeSettingsObject.timeFormat, localeSettingsObject.timestampSeparator), true);
}
...
function localizedTimestampToIsoTimestamp(localizedTimestampString) {
  return convert(localizedTimestampString, toMomentTimestampPattern(localeSettingsObject.dateFormat, localeSettingsObject.timeFormat, localeSettingsObject.timestampSeparator), ISO_8601_TIMESTAMP_PATTERN);
}

function isoTimestampToLocalizedTimestamp(isoTimestampString) {
  return convert(isoTimestampString, ISO_8601_TIMESTAMP_PATTERN, toMomentTimestampPattern(localeSettingsObject.dateFormat, localeSettingsObject.timeFormat, localeSettingsObject.timestampSeparator));
}
...
function isoTimestampToLocalizedTimestampByTimezone(value, timezone) {
  ...
  return momentTimestamp.format(toMomentTimestampPattern(localeSettingsObject.dateFormat, localeSettingsObject.timeFormat, localeSettingsObject.timestampSeparator));
}
