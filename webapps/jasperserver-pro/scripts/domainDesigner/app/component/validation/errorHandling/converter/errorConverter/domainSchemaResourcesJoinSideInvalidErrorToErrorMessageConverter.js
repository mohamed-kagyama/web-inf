...
module.exports = {
  convert: function convert(error) {
    var invalidValueProperty = extractPropertyByKeyUtil.extract(error.parameters, errorParametersKeysEnum.INVALID_VALUE),
        resourcePathProperty = extractPropertyByKeyUtil.extract(error.parameters, errorParametersKeysEnum.RESOURCE_PATH);
    return i18nMessage('domain.designer.error.dialog.schema.resources.join.side.invalid.error.template', invalidValueProperty.value, resourcePathProperty.value);
  }
};
