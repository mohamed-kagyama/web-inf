...
module.exports = {
  create: function create(options) {
    ...
    eventHandler[menuOptionsEventsEnum.REMOVE_TABLE_REFERENCE.eventWithPrefix] = function (item, event, view, model) {
      var itemId = getTableReferenceIdByItem(item.resource);
