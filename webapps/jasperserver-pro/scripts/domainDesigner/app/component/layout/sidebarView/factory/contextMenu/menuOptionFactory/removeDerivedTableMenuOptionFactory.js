...
module.exports = {
  create: function create(options) {
    ...
    return function (item) {
      return {
        label: i18nMessage('domain.designer.derivedTables.removeDerivedTables'),
        action: menuOptionsEventsEnum.REMOVE_DERIVED_TABLE.event,
        value: false,
        triggerEvent: applicationStateEventsEnum.SIDEBAR_TREE_MENU_REMOVE_DERIVED_TABLE,
        test: function test() {
