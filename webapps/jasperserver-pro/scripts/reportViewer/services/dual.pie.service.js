...
var JRDualPieSettingService = {
  ...
  setupDualPie: function setupDualPie(options) {
    ...
    parentSeries.showInLegend = false;
    ...
    childSeries.point = childSeries.point || {};
    childSeries.point.events = childSeries.point.events || {};

    childSeries.point.events.legendItemClick = childSeries.point.events.legendItemClick || function (event) {
