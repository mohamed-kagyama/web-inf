...
<t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
    ...
    <t:putAttribute name="footerContent">
        ...
        <button class="button action up cancelButton">
            <span class="wrap"><spring:message code="button.cancel" javaScriptEscape="true"/></span>
...
<tiles:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <tiles:putAttribute name="bodyContent">
        <t:insertTemplate template="/WEB-INF/jsp/templates/pageHeader.jsp">
            <tiles:putAttribute name="pageHeaderIconClass" value="adhoc" cascade="false"/>
            <tiles:putAttribute name="pageHeaderText" value="${pageHeaderText}" cascade="false"/>
        </t:insertTemplate>
            ...
            <tiles:putAttribute name="headerContent" cascade="false">
                <div id="adhocToolbar" class="toolbar">
                    <ul class="list buttonSet">
                        ...
                        <li class="node">
                            <c:if test="${olapCrosstabMode != 'selected'}">
                                ...
                                <ul class="list buttonSet olapNo last">
                                    ...
                                    <authz:authorize access="hasAnyRole('ROLE_SUPERUSER', 'ROLE_ADMINISTRATOR')">
                        ...
                        <li class="node first">
                            <ul class="list buttonSet">
                                <li class="leaf"><button id="changeVisualizationButton" title="<spring:message code='ADH_1214_ICHARTS_DIALOG_CHART_TYPE_TITLE'/>" class="button capsule up"><span class="wrap">Select Visualization Type<span class="icon"></span></span></button></li>
                            </ul>
                        </li>
        ...
        <t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
            ...
            <t:putAttribute name="footerContent">
                ...
                <button id="closeTemplateProperties" class="button action up"><span class="wrap"><spring:message code="button.close" javaScriptEscape="true"/><span class="icon"></span></button>
            </t:putAttribute>
        </t:insertTemplate>
