...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <t:putAttribute name="headerContent">
        <c:if test='${!empty param.phantomjs && param.phantomjs == "true"}'>
            <script type="text/javascript" src="${pageContext.request.contextPath}/runtime/${jsOptimizationProperties.runtimeHash}/scripts/runtime_dependencies/core-js-bundle/minified.js"></script>
        </c:if>
